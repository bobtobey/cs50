...
SELECT 'temp_people_table' AS table_name, temp_people_table.name, temp_people_table.id, pc.caller, p.passport_number, bsl.license_plate FROM temp_people_table
    ...
    JOIN atm_transactions AS atm ON temp_people_table.
