...
SELECT DISTINCT(name), birth, year FROM people JOIN stars ON people.id = stars.person_id JOIN movies on stars.movie_Id = movies.id WHERE year = 2004 ORDER BY birth;
